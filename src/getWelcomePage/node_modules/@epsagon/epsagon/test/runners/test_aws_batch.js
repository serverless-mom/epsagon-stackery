...
describe('AWS Batch createRunner tests', () => {
    beforeEach(() => {
        ...
        this.getStub.callsArgWith(1, null, null, JSON.stringify({ region: 'test-reg' }));
    ...
    it('createRunner: get region fails', (done) => {
        this.getStub.callsArgWith(1, new Error('test'));
        const env = {
            AWS_BATCH_JOB_ID: 'test-id',
            AWS_BATCH_JQ_NAME: 'jq',
            AWS_BATCH_CE_NAME: 'ce',
    ...
    it('createRunner: get region invalid JSON', (done) => {
        this.getStub.callsArgWith(1, null, null, '{invalid json');
        const env = {
            AWS_BATCH_JOB_ID: 'test-id',
            AWS_BATCH_JQ_NAME: 'jq',
            AWS_BATCH_CE_NAME: 'ce',
